...
def run_calling(
    ...
    *,
    ...
    rnas_with_contacts = set(contacts_by_rna.keys())
    ...
    if threads <= 1:
        ...
        for row_dict, cis_chr, rna_cont in tasks:
            ...
            if params.return_all_bins and all_bins is not None:
    ...
    if params.return_all_bins and all_bins is not None and len(all_bins) > 0:
        bins_all = pd.concat(all_bins, ignore_index=True)
    else:
